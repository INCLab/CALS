...
```shell
cd <ByteTrack_HOME>
python3 tools/model.py -f exps/example/mot/yolox_x_ablation.py -d 8 -b 48 --fp16 -o -c pretrained/yolox_x.pth
```
...
```shell
cd <ByteTrack_HOME>
python3 tools/model.py -f exps/example/mot/yolox_x_mix_det.py -d 8 -b 48 --fp16 -o -c pretrained/yolox_x.pth
```
...
```shell
cd <ByteTrack_HOME>
python3 tools/model.py -f exps/example/mot/yolox_x_mix_mot20_ch.py -d 8 -b 48 --fp16 -o -c pretrained/yolox_x.pth
```
...
```shell
cd <ByteTrack_HOME>
python3 tools/model.py -f exps/example/mot/your_exp_file.py -d 8 -b 48 --fp16 -o -c pretrained/yolox_x.pth
```
