...
mot_json = json.load(open('datasets/mot/annotations/model.json','r'))
...
ethz_json = json.load(open('datasets/ETHZ/annotations/model.json','r'))
img_id_count = 0
...
cp_json = json.load(open('datasets/Cityscapes/annotations/model.json','r'))
img_id_count = 0
...
json.dump(mix_json, open('datasets/mix_det/annotations/model.json','w'))
